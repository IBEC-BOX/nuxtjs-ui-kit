  ...
  <div class="mb-3 file-field">
    <label :for="name" class="form-label d-flex align-items-center">
      ...
      <div
        ...
        :data-bs-title="`
                ...
                <br>
                <span>${$t(
                  `Общий объём файлов не должен превышать ${limit} МБ.`
                )}</span>`"
    ...
    <div class="selectFiles">
      ...
      <div ref="fileform" class="files-button-wrap">
        <button
          :class="['files-button', fileDropClass]"
          type="button"
          @click="addFiles()"
        >
          ...
          <span v-if="dragAndDropCapable" class="files-button-grey">{{
            $t("или перетащите его сюда")
          }}</span>
        </button>
      </div>
